codeunit 50145 INHTransferOrderPostShipment
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // Axx°.1        SSC  27.06.12  "Zu Liefern manuell gesetzt" zurücksetzen nach Warenausgang
    // A08°          RBI  29.07.08  Anpassungen übernommen
    // C27°          SSC  23.02.17  Hooks
    // C34°.6        SSC  25.01.22  Möglichkeit Lieferscheinnr. "vorzureservieren"
    ...
    begin
        ...
        with TransHeader do begin
            ...
            if TransLine.Find('-') then
                repeat
                    ...
                    if TransLine."Item No." <> '' then begin
                        ...
                        //A08°:Item.TESTFIELD(Blocked,FALSE);
                    end;
            ...
            if TransLine.Find('-') then begin
                ...
                repeat
                    ...
                    TransLine."Qty. to Receive" := TransLine."Qty. in Transit";   //A08°
                    TransLine."Qty. to Receive (Base)" := TransLine."Qty. in Transit (Base)";   //A08°
                    TransLine."Zu Liefern manuell gesetzt" := false;   //Axx°.1
        ...
        lo_cu_Logistikverwaltung.fnk_Cu5704_OnAfterTransferOrderPostShipment(Rec, TransShptHeader);   //C27°
    end;
    ...
    begin
        with ItemJnlLine do begin
            ...
            //START A08° ---------------------------------
            ItemJnlLine."Geliefert von" := TransShptHeader2."Geliefert von";
            ItemJnlLine."Kommisioniert von" := TransShptHeader2."Kommissioniert von";
            //STOP  A08° ---------------------------------
        end;
    ...
    begin
        ...
        //START C34°.6 ---------------------------------
        if TransHeader."Shipment No." <> '' then begin
            TransShptHeader."No." := TransHeader."Shipment No.";
        end else begin
            //STOP  C34°.6 ---------------------------------
