codeunit 50169 INHBlanketPurchOrderToOrder
{
    ...
    // ------------------------------------------------------------
    // Axx°          SSC  16.06.11  Lieferinfo nicht von Rahmbenbestellung übernehmen
    ...
    var
        ...
        lo_re_PurchBOLineTemp: Record "Purchase Line" temporary;
    ...
    local procedure ResetQuantityFields(var PurchLine: Record "Purchase Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterResetQuantityFields(var PurchaseLine: Record "Purchase Line")
    begin
    end;
