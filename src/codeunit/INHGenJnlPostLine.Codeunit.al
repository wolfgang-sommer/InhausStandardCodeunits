codeunit 50113 INHGenJnlPostLine
{
    ...
    // ------------------------------------------------------------
    // Axx°.1        SSC  27.07.18  Skonto soll immer möglich sein (war so in NAV2009 Standard)
    // Axx°.2        SSC  23.01.19  Kred. RE/GS Nr. nur 3 Jahre zurück prüfen, da manche Kreditoren Nummernkreise neu verwenden (siehe auch Cu90,Axx°.2 und Cu50033,Axx°.8)
    // B28°          SSC  06.05.11  Bonusgutschrift
    // C27°          SSC  11.07.17  Hooks
    ...
    begin
        ...
        OldVendLedgEntry.SetFilter("Posting Date", '>%1', CalcDate('<-3Y>'));   //Axx°.2
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFinishPosting(var GlobalGLEntry: Record "G/L Entry"; var GLRegister: Record "G/L Register"; var IsTransactionConsistent: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostDtldCVLedgEntryOnBeforeCreateGLEntryGainLoss(var GenJournalLine: Record "Gen. Journal Line"; DtldCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer"; var Unapply: Boolean; var AccNo: Code[20])
    begin
    end;
