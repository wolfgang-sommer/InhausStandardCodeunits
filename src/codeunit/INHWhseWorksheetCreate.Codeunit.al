codeunit 50164 INHWhseWorksheetCreate
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // C54°          RBI  12.04.19  FindLastWhseWkshLine und CreateWhseWkshLine - Funktion auf Global gestellt
    //               RBI  16.01.20  Publisher Event OnAfterCreateWhseWkshLine in Funktion CreateWhseWkshLine
    ...
    [Scope('Internal')]
    procedure CreateWhseWkshLine(var WhseWkshLine: Record "Whse. Worksheet Line") Created: Boolean
    var
        Item: Record Item;
    ...
    begin
        ...
        OnAfterCreateWhseWkshLine(WhseWkshLine);  //C54°
    end;
    ...
    [BusinessEvent(false)]
    [Scope('Internal')]
    procedure OnAfterCreateWhseWkshLine(par_re_WhseWorksheetLine: Record "Whse. Worksheet Line")
    begin
    end;
}
