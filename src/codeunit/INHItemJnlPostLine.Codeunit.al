codeunit 50121 INHItemJnlPostLine
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // Axx°          RBI  24.07.08  Anpassungen in CU übernommen
    // Axx°.2        SSC  11.08.16  Dialogfenster nur wenn guiallowed
    // A28°          RBI  24.07.08  Felder die beim Buchen der Item Journal Line gefüllt werden.
    // A70°          SSC  12.08.09  Beschreibung 2 berücksichtigen
    // C24°          SSC  29.07.16  Cut Off: Posten aus Archiv müssen berücksichtigt werden; Storno ermöglichen
    //               SSC  11.11.16  Bei Storno Buchungsdatum auf Workdate
    // C27°          SSC  27.07.17  Events, Hooks
    ...
    begin
        ...
        if not PostItemJnlLine then
            PostItemJnlLine := ItemJnlLineToPost.IsNotInternalWhseMovement;
    ...
    begin
        ...
        repeat
            ...
            if AppliedQty <> 0 then begin
                ...
                if not lo_bo_IsILEArchive then   //C24°
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            //START Axx° ---------------------------------
            if ("Lot No." <> '') and (StrLen("Lot No.") < 6) then
                Error(TextLotNoError, "Lot No.", "Document No.", "Item No.");
            //STOP  Axx° ---------------------------------
    ...
    begin
        ...
        //START C24° ---------------------------------
        if ItemJnlLine.Correction then begin
            NewValueEntry."Posting Date" := ItemJnlLine."Posting Date";
        end;
        //STOP  C24° ---------------------------------
    ...
    begin
        exit(
          ...
          (Item.Get(ItemJournalLine."Item No.") and (Item."Costing Method" = Item."Costing Method"::Average) or
