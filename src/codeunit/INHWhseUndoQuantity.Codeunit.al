codeunit 50162 INHWhseUndoQuantity
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // C54°          RBI  20.02.20  UpdateWhseRequestShpt - Prüfen ob IC-Auftrag
    ...
    var
        ...
        SalesLine: Record "Sales Line";
        "+++VAR_Inhaus+++": Boolean;
        lo_re_SalesLineVIEW: Record VIEW_SalesLine;
    begin
        with PostedWhseShptLine do begin
            case "Source Type" of
                DATABASE::"Sales Line":
                    begin
                        //START C54° ---------------------------------
                        //SalesLine.GET("Source Subtype","Source No.","Source Line No.");
                        if not SalesLine.Get("Source Subtype", "Source No.", "Source Line No.") then begin
                            lo_re_SalesLineVIEW.SetRange("Document Type", "Source Subtype");
                            lo_re_SalesLineVIEW.SetRange("Document No.", "Source No.");
                            lo_re_SalesLineVIEW.SetRange("Line No.", "Source Line No.");
                            lo_re_SalesLineVIEW.FindFirst;
                            SalesLine.TransferFields(lo_re_SalesLineVIEW);
                        end;
                        //STOP  C54° ---------------------------------
