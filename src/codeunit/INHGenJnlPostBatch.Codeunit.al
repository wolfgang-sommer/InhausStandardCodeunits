codeunit 50112 INHGenJnlPostBatch
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // Axx°.1        SSC  18.10.18  Standard BUG: GenJnlLine."Line No." wird mit der Nr. des Journals zurückgegeben (war in 2009 schon so),
    //                               damit das richtige gedruckt wird (siehe auch Cu232)
    ...
    [Scope('Internal')]
    procedure fnk_GetGLRegNo() rv_in_GLRegNo: Integer
    begin
        //Axx°.1
        rv_in_GLRegNo := GLRegNo;
    end;
