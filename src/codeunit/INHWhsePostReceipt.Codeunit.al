codeunit 50156 INHWhsePostReceipt
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // A08°.1        SSC   12.07.18  Beim Wareneingang sind bestimmte Prüfungen der Freigabe nicht relevant
    // C54°          RBI   12.04.19  Code - Aufruf fnk_Cu5760_OnAfterCode um Parameter erweitert
    //               RBI   26.04.19  Funktion CreatePutAwayDoc auf Global umgestellt
    //               RKN   23.01.19  Alternative Einlagerungen
    ...
    begin
        lo_bo_IsAutoProcess := lo_cu_OverallVariableMgt.fnk_GetIsAutomatedProcess;   //C54°
        lo_cu_LogisticsMgt.fnk_Cu5760_OnBeforeCode(WhseRcptLine);   //A08°
        lo_cu_OverallVariableMgt.fnk_SetIsAutomatedProcess(lo_bo_IsAutoProcess);   //C54°
        ...
        lo_cu_LogisticsMgt.fnk_Cu5760_OnAfterCode(WhseRcptHeader, WhseRcptLine);   //A08°//C54°
    end;
                ...
                DATABASE::"Purchase Line":
                    begin
                        ...
                        then begin
                            ...
                            lo_cu_OverallVariableMgt.fnk_SetFromWhsePost(true);   //A08°.1
                            PurchRelease.Run(PurchHeader);
                            lo_cu_OverallVariableMgt.fnk_GetAndClearFromWhsePost;   //A08°.1
                            ModifyHeader := true;
                        end;
    ...
    begin
        with PostedWhseRcptLine do begin
            ...
            TempWhseJnlLine.Description := TransHeader."No.";   //A08°
            TempWhseJnlLine.Insert;
        end;
    end;

    [Scope('Internal')]
    procedure CreatePutAwayDoc(WhseRcptHeader: Record "Warehouse Receipt Header")
    var
