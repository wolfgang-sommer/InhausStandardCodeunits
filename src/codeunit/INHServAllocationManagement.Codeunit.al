codeunit 50140 INHServAllocationManagement
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    var
        ...
        lo_ServicetoSalesMgt: Codeunit "Service to Sales Mgt.";
    begin
        //START C40° ---------------------------------
        if lo_ServicetoSalesMgt.fnk_CreateAllocationEntry(DocumentType, DocumentNo, ServItemLineNo, ServItemNo) then exit;
        //STOP  C40° ---------------------------------
        ServHeader.Get(DocumentType, DocumentNo);
