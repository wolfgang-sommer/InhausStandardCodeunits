codeunit 50122 INHItemJnlPostPrint
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // B39°          RBI  06.10.11  Lagerplatzjournal Druck wird nicht benötigt - Abfrage auf Report ID
    ...
    begin
        with ItemJnlLine do begin
            ...
            if WhseReg.Get(ItemJnlPostBatch.GetWhseRegNo) then begin
                ...
                //START B39° ----------------------------------------------
                if ItemJnlTemplate."Whse. Register Report ID" <> 0 then
                    //STOP B39° ----------------------------------------------
