codeunit 50146 INHUndoPostingManagement
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // C23°          SSC  02.03.16  Bestimmte Prüfungen nicht machen beim Stornieren
    // C54°          RBI  05.09.19  TestAllTransactions - Test auf WhseWorksheetLine deaktiviert
    ...
    begin
        ...
        then begin
            ...
            //C23°:TestRgstrdWhseActivityLine(UndoLineNo,SourceType,SourceSubtype,SourceID,SourceRefNo);
            //C54°:TestWhseWorksheetLine(UndoLineNo,SourceType,SourceSubtype,SourceID,SourceRefNo);
        end;
        ...
        //C23°:TestPostedWhseShipmentLine(UndoLineNo,SourceType,SourceSubtype,SourceID,SourceRefNo);
    ...
    begin
        ...
        //C23°:TestRgstrdWhseActivityLine2(UndoLineNo,PostedWhseReceiptLine);
