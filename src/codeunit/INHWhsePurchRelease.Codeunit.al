codeunit 50159 INHWhsePurchRelease
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if not WhseRqst.IsEmpty then begin
                ...
                WhseRqst.ModifyAll(Auftragsstatus, WhseRqst.Auftragsstatus::"Nicht verfügbar");   //A08°
            end;
        end;
    ...
    begin
        ...
        then begin
            ...
            PurchLine2.SetFilter("Return Qty. to Ship", '<>0');
            if PurchLine2.FindFirst then begin
                WhseRqst.Lieferdatum := PurchLine2."Expected Receipt Date";
                WhseRqst.Auftragsstatus := WhseRqst.Auftragsstatus::"Lieferfähig";
            end else begin
                WhseRqst.Lieferdatum := PurchHeader."Expected Receipt Date";
                WhseRqst.Auftragsstatus := WhseRqst.Auftragsstatus::"Nicht verfügbar";
            end;
            //STOP  A08° ---------------------------------
