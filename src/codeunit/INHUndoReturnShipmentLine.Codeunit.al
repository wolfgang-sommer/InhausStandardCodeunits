codeunit 50149 INHUndoReturnShipmentLine
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    //               RBI  05.02.09  Bei Rücklieferung stornieren das Buchungsdatum auf WORKDATE setzen.
    // C27°          SSC  23.08.17  Hooks
    ...
    begin
        ...
        lo_cu_PurchMgt.fnk_Cu5814_OnAfterCode(ReturnShptLine);   //C27°
