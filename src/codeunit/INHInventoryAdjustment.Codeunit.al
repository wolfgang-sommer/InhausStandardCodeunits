codeunit 50117 INHInventoryAdjustment
{
    // +---------------------------------------------+
    // +                                             +
    // +           Inhaus Handels GmbH               +
    ...
    // ------------------------------------------------------------
    // C24°          SSC  01.11.16  Dialogfenster nur wenn guiallowed
    ...
    local procedure IsAvgCostItem(): Boolean
    begin
    ...
    begin
        if not GuiAllowed then exit;   //C24°
        Window.Open(
          Text000 +
          '#1########################\\' +
          Text001 +
